...
$redirect_url='https://4in-1.cgpay.in/';    
 ...
 $txn_data = file_get_contents('https://4in-1.cgpay.in/phnpe/user_txn.php?no='.$user_token.''); 
...
function upiCountdown(elm, minute, second, url) {
    ...
    function startTimer() {
        ...
        if(m < 0){
            ...
            window.location.href = "https://4in-1.cgpay.in";
        }
...
function check() {
    $.ajax({
        type: 'post',
        url: 'https://4in-1.cgpay.in/order2/payment-status',
