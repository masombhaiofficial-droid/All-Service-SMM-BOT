        ...
        if (!empty($existing_order_result)) {
            ...
            exit;
                ...
                if ($bydb_order_hdfc_conn == "Yes") {
                    ...
                    $txn_data = file_get_contents("https://4in-1.cgpay.in/HDFCSoft/payrequest.php?sessionid=$db_seassion&cnumber=$customer_mobile&amount=$amount&no=$customer_mobile&tidList=$tidlist&dis=$diss");
...
setXbyY($sql);
                ...
                elseif ($bydb_order_phonepe_conn == "Yes") {
                    ...
                    if ($expire_date >= $today) {
                        ...
                        $payment_link = "https://4in-1.cgpay.in/payment2/instant-pay/" . $link_token;
...
setXbyY($sql);
                ...
                elseif ($bydb_order_paytm_conn == "Yes") {
                    ...
                    if ($expire_date >= $today) {
                        ...
                        // Construct the payment link
                        $payment_link = "https://4in-1.cgpay.in/payment3/instant-pay/" . $link_token;
...
setXbyY($sql);
                ...
                elseif ($bydb_order_bharatpe_conn == "Yes") {
                    ...
                    if ($expire_date >= $today) {
                        ...
                        // Construct the payment link
                        $payment_link = "https://4in-1.cgpay.in/payment4/instant-pay/" . $link_token;
...
setXbyY($sql);
                ...
                elseif ($bydb_order_hdfc_conn == "No" || $bydb_order_phonepe_conn == "No" || $bydb_order_paytm_conn == "No" || $bydb_order_bharatpe_conn == "No") {
