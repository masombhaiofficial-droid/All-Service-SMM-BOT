...
<head>
	...
	<title>Upi Sivaji Gateway</title>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  <p>This Upi Sivaji Gateway does not provide any Payment Gateway services, UPI Accounts, or UPI Merchant Accounts.</p>
...
if (isset($_POST['submit'])) {
    ...
    $password = mysqli_real_escape_string($conn, $_POST['password']); // Password submitted by the user
