...
if(isset($_POST['get_api_token'])){
    ...
    //now to update user_id in table store_id
    ...
    //now to update user_id in table paytm_tokens
...
<div class="main-panel">
  ...
  "redirect_url": "https://4in-1.cgpay.in"
}</textarea>
    ...
    "amount": "1",
    "order_id": "8787772321800",
    "payment_link": "https://4in-1.cgpay.in/payment/pay.php?data=ODc4Nzc3Mj==&88e76a199",
    "order_id": "8052313697"
}</textarea>
	...
	"status": "SUCCESS",
    "amount": "2.00",
    "order_id": "878777878754",
    "UTR": "329446199904",
    "VPA": "Upi Sivaji Gateway@ybl",
    "customer_mobile": "8619170399"}</textarea> 
								</div>
								<div class="col-md-6 mb-2">
									<label>Failed Response</label>
									<textarea type="text" placeholder="Failed Response" class="form-control" style="height: 140px;" readonly>{
