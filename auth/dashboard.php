						...
						<div class="row row-card-no-pd">
							<div class="col-md-12">
								<h6 class="btn badge bg-danger text-white mb-4" style="width: 100%;font-size:20px; ">
									...
									<marquee style="color: white;margin-bottom: -8px;" onmouseover="this.stop();" onmouseout="this.start();" direction="left" height="25">Plan Purchase karne ke baad time aage na badhe to 9580278711 pe msg kren All Working Fine thank you Upi Sivaji Gateway
									</marquee>
								</h6>
